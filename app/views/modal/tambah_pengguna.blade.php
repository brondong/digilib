...
<div class="modal-body">
	{{ Form::open(array('route' => 'tambah_pengguna', 'files' => true, 'class' => 'form-horizontal form-tambah-pengguna')) }}
		...
		<div class="control-group" id="control-username">
			...
			<div class="controls">
				{{ Form::text('username', null, array( 'id' => 'username', 'onkeypress' => 'enterTambahPengguna(event)', 'maxlength' => 20, 'autocomplete' => 'off', 'placeholder' => 'Ketikkan username pengguna...')) }}
		...
		<div class="control-group" id="control-password">
			...
			<div class="controls">
				{{ Form::password('password', array( 'id' => 'password', 'onkeypress' => 'enterTambahPengguna(event)', 'placeholder' => 'Ketikkan password pengguna...')) }}
				<span class="help-block" id="error-password"></span>
			</div>
		</div>
</div>
<div class="modal-footer">
	{{ Form::button('Simpan', array('class' => 'btn btn-primary', 'onclick' => 'tambahPengguna()')) }}
