<div class="text-center">
	<div class="form-inline formulir text-right">
		<span class="control-group" id="control-urut-peminjaman">
			...
			<span class="controls">
				{{ Form::text('tanggal-awal', $awal, array('class' => 'tanggal', 'id' => 'tanggal-awal', 'onchange' =>'tampilPeminjaman()', 'readonly' => 'readonly', 'placeholder' => 'Ketikkan tanggal awal...'));
				}}
			</span>
		</span>
			<span class="controls">
				{{ Form::text('tanggal-akhir', $akhir, array('class' => 'tanggal', 'id' => 'tanggal-akhir', 'onchange' =>'tampilPeminjaman()', 'readonly' => 'readonly', 'placeholder' => 'Ketikkan tanggal akhir...'));
				}}
			</span>
...
@else
	<div class="alert kosong">
		<strong>Peringatan!</strong> Data peminjaman yang anda inginkan tidak ada.
	</div>
