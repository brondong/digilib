		...
		<span class="control-group" id="control-urut-buku">
			...
			<span class="controls">
				{{ Form::select('kolom-buku', array(
					...
					), 'judul', array('id' => 'kolom-buku', 'onchange' =>'urutBuku()'));
				}}
			</span>
		</span>
			<span class="controls">
				{{ Form::select('tipe-buku', array('asc' => 'Ascending', 'desc' => 'Descending'), 'asc', array('id' => 'tipe-buku', 'onchange' =>'urutBuku()')); }}
			</span>
...
@else
	...
	<div class="alert kosong">
		<strong>Peringatan!</strong> Belum ada data buku yang tersimpan di basis data.
	</div>

	<div id="jarak"></div>

	<div class="btn-group">
		{{ Form::button('<i class="icon-plus"></i>', array('class' => 'btn', 'onclick' => 'modalTambahBuku()')) }}
	</div>
@endif
</div>