...
@if(count($kembali))
	<div class="form-inline formulir text-right">
		<span class="control-group" id="control-urut-pengembalian">
			...
			<span class="controls">
				{{ Form::text('tanggal-awal', null, array('class' => 'tanggal', 'id' => 'tanggal-awal', 'onchange' =>'tampilPengembalian()', 'readonly' => 'readonly', 'placeholder' => 'Ketikkan tanggal awal...'));
				}}
			</span>
		</span>
			<span class="controls">
				{{ Form::text('tanggal-akhir', null, array('class' => 'tanggal', 'id' => 'tanggal-akhir', 'onchange' =>'tampilPengembalian()', 'readonly' => 'readonly', 'placeholder' => 'Ketikkan tanggal akhir...'));
				}}
			</span>
...
@else
	<div class="alert kosong">
		<strong>Peringatan!</strong> Belum ada data pengembalian yang tersimpan di basis data.
	</div>
@endif
</div>